...
public:
    JoystickTrigger() : Node("joystick_trigger_ai_mode"), triggered_(false) 
    {
...
private:
    void joyCallback(const sensor_msgs::msg::Joy::SharedPtr msg)
    {
        ...
        if (!triggered_ && forward_axis > 0.2) {
            ...
            system("ros2 launch andromina_control_bringup andromina_ai.launch.py &"); 
        }
       ...
       if (msg->buttons[0] || msg->buttons[1] || msg->buttons[2] || msg->buttons[3]) {
         ...
         system("pkill -2 -f 'ros2 launch andromina_control_bringup andromina_ai.launch.py'");
         system("pkill -2 -f andromina_ai_driver");
      }
